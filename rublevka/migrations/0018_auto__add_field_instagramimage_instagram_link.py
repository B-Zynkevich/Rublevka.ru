...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.instagram_link'
        db.add_column(u'rublevka_instagramimage', 'instagram_link',
                      self.gf('django.db.models.fields.URLField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.instagram_link'
        db.delete_column(u'rublevka_instagramimage', 'instagram_link')
