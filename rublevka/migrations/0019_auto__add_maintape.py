...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MainTape'
        db.create_table(u'rublevka_maintape', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_publishing', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'rublevka', ['MainTape'])


    def backwards(self, orm):
        # Deleting model 'MainTape'
        db.delete_table(u'rublevka_maintape')
