...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.is_important'
        db.add_column(u'rublevka_article', 'is_important',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.is_important'
        db.delete_column(u'rublevka_article', 'is_important')
