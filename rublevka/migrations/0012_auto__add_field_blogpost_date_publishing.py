...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.date_publishing'
        db.add_column(u'rublevka_blogpost', 'date_publishing',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.date_publishing'
        db.delete_column(u'rublevka_blogpost', 'date_publishing')
