...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rublevka_instagramaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instagram_id', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('profile_picture', self.gf('django.db.models.fields.URLField')(max_length=300, null=True, blank=True)),
        ))
        db.send_create_signal(u'rublevka', ['InstagramAccount'])


    def backwards(self, orm):
        # Deleting model 'InstagramAccount'
        db.delete_table(u'rublevka_instagramaccount')
